<div align="center">
  ...
  <h3 align="center">A Car Showcase Website</h3>
   ...
   <div align="center">
     This is a carhub website where you can find all the cars and their details. You can also filter the cars based on their manufacturer, year of production and fuel type. You can also search for a particular car. This website is built using Next.js, TypeScript and Tailwind CSS.
    </div>
</div>
...
This repository contains the code for the Car Showcase website. Where you can find all the cars and their details. You can also filter the cars based on their manufacturer, year of production and fuel type. You can also search for a particular car. This website is built using Next.js, TypeScript and Tailwind CSS.
